...
![Claude Code](https://img.shields.io/badge/Claude_Code-v2.1.76+-blueviolet)
...
Current: **v2.18.0** (2026-03-16) — Claude Code v2.1.63+ compatible. See [CHANGELOG.md](CHANGELOG.md) for full history.
