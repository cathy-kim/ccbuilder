...
| **MCP OAuth** | 콜백 포트 충돌·재인증 수정 (v2.1.74); CIMD/SEP-991 (Client ID Metadata Document) 지원 (v2.1.81) |
...
**신규 필드 (v2.1.69)**: `agent_id`, `agent_type`, `worktree` (모든 이벤트에 추가) | **HTTP Hook (v2.1.63)**: `type: "http"` — URL로 JSON POST | **v2.1.83+**: `CwdChanged`, `FileChanged` (v2.1.83), `TaskCreated` (v2.1.84)
...
---
**Status**: UPDATED (2026-03-17) | **Claude Code**: v2.1.84+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
