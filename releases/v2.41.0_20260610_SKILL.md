...
---
**Status**: 2026-05-03 | **Claude Code**: v2.1.169+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
