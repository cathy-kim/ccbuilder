...
| **PostToolUse** | 도구 호출 후 | No | `tool_name`, `tool_result`, `duration_ms` (v2.1.119: 도구 실행 시간, ms) |
| **PostToolUseFailure** | 도구 호출 실패 후 | No | `tool_name`, `error`, `duration_ms` (v2.1.119: 도구 실행 시간, ms) |
