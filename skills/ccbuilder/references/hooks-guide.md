...
| **Elicitation** | MCP 서버 입력 요청 인터셉트 (v2.1.76) | Yes (override) | `server_name`, `prompt`, `schema` |
| **ElicitationResult** | MCP 서버 입력 결과 인터셉트/오버라이드 (v2.1.76) | Yes (override) | `server_name`, `result` |
