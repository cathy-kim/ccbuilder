...
| **`workspace` 예약명** | `workspace` 서버명 예약 → 동명 서버 스킵·경고 (v2.1.128) **Breaking Change** |
| **재연결 요약** | 재연결 시 도구 목록 홍수 → 서버 접두사별 요약 표시 (v2.1.128) |
| **`/mcp` 도구 수** | `/mcp`에서 서버별 도구 수 및 0도구 서버 표지 (v2.1.128) |
