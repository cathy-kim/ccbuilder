...
**Last Synced**: 2026-08-08 (Claude Code v2.1.226+)
...
| `SendMessage` | 1,241 | 팀메이트 메시지 (Agent Teams); 크로스 세션·크로스 머신 메시징 — `ListAgents`로 발견한 세션·Remote Control 대상에 이름으로 먼저 메시지 시작 가능 (v2.1.224+) | 낮음 |
