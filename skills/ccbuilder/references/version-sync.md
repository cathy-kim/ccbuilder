...
### v2.1.87 (2026-03-30 동기화)

**새로운 기능 (v2.1.86):**
- `X-Claude-Code-Session-Id` 헤더 — API 요청에 세션 ID 포함, 프록시에서 파싱 없이 세션별 집계
- `.jj`, `.sl` VCS 디렉토리 제외 목록 추가 (Grep·파일 자동완성에서 Jujutsu/Sapling 메타데이터 미진입)
