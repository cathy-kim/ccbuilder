...
기본적으로 MCP 도구 결과는 크기가 제한됩니다. `_meta["anthropic/maxResultSizeChars"]` annotation으로 최대 500K 문자까지 확장 가능합니다.

DB 스키마, 대형 파일 목록 등 큰 결과를 반환하는 도구에 활용하세요:
...
> 이 annotation이 없으면 기본 제한이 적용됩니다. 필요한 도구에만 선택적으로 적용하세요.
