...
| 세션당 서브에이전트 파견 총량 | 기본 200개, `/clear`로 리셋 (`CLAUDE_CODE_MAX_SUBAGENTS_PER_SESSION`, v2.1.212) — 이와 별개로 있던 "200개 도달 시 신규 에이전트 파견 완전 거부" 하드 캡은 v2.1.224에서 제거됨(동시성·깊이 제한은 유지) |
