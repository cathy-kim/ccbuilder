...
### Task Management (신규) — ⚠️ v2.1.233: Opus 4.8·Sonnet 5·Fable 5·Mythos 5+ 모델에서 TaskCreate/Get/Update/List·TodoWrite 기본 비활성화, `CLAUDE_CODE_ENABLE_TODO_TOOLS=1`로 복원
