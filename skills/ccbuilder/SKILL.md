...
| **MCP 결과 크기 오버라이드** | `_meta["anthropic/maxResultSizeChars"]` 어노테이션 — 최대 500K 확장 (DB 스키마 등, v2.1.91) |
