...
| **MCP 결과 크기 오버라이드** | `_meta["anthropic/maxResultSizeChars"]` annotation — 도구 결과 최대 500K까지 확장 (DB 스키마 등, v2.1.91) |
...
| `/tag` 명령 | 제거됨 (v2.1.92) |
| `/vim` 명령 | `/config` → Editor mode 사용 (v2.1.92) |
...
---
**Status**: 2026-03-27 | **Claude Code**: v2.1.92+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
