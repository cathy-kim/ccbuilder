...
| [references/official/hooks.md](references/official/hooks.md) | Hooks 공식 문서 요약 (27 events) |
...
---
**Status**: 2026-06-18 | **Claude Code**: v2.1.220+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
