...
| `TaskGet` | 개별 작업 상세 조회; **v2.1.233**: Opus 4.8·Sonnet 5·Fable 5·Mythos 5 이상 모델에서 Task/Todo 도구(TaskCreate/Get/Update/List, TodoWrite) 기본 비활성화 — `CLAUDE_CODE_ENABLE_TODO_TOOLS=1`로 복원 |
...
---
**Status**: 2026-06-18 | **Claude Code**: v2.1.233+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
