...
| `PermissionRequest` agent-type hook | command 또는 http hook 사용 (v2.1.280) |
...
**Status**: 2026-06-18 | **Claude Code**: v2.1.281+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
