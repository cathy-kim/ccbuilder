...
| `TaskGet` | 개별 작업 상세 조회 — **Opus 4.8·Sonnet 5·Fable 5·Mythos 5+ 모델은 TaskCreate/Update/List/Get·TodoWrite 기본 비활성화**, `CLAUDE_CODE_ENABLE_TODO_TOOLS=1`로 복원 (v2.1.233) |
