...
벡터 임베딩 기반 시맨틱 코드 검색. 자연어로 "보안 Hook 패턴" 같은 검색 가능.

**Option A: Gemini + Zilliz Free** (가장 간단)
```bash
# 1. Zilliz Cloud 무료 가입: https://cloud.zilliz.com/signup (5GB 무료)
# 2. MCP 추가
...
**Status**: UPDATED (2026-02-13) | **Claude Code**: v2.1.53+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
