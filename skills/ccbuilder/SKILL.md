...
| **claude.ai MCP connectors** | claude.ai MCP 커넥터 사용 (v2.1.46); `ENABLE_CLAUDEAI_MCP_SERVERS=false` 비활성화 (v2.1.63); 로컬 설정과 중복 시 로컬 우선 (v2.1.84); `/mcp`에서 동일 URL 로컬 서버에 숨겨진 커넥터 표시 + 중복 제거 힌트 (v2.1.122) |
