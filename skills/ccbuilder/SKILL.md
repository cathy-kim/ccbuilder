...
| **MCP 도구 호출 축소** | read/search 호출 "Queried {server}" 단일 라인 표시, Ctrl+O 확장 (v2.1.81); `/mcp` 연결 서버 도구 수 표시·0개 서버 플래그 (v2.1.128); `workspace` 예약 서버명 — 해당 이름 서버 경고 후 건너뜀 (v2.1.128) |
