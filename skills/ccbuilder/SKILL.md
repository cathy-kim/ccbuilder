...
| **MCP stdio 시작 최적화** | 다중 stdio 서버 동시 구성 시 빠른 시작; `resources/templates/list` 첫 `@`-멘션 시로 지연 (v2.1.116) |
...
---
**Status**: 2026-03-27 | **Claude Code**: v2.1.116+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
