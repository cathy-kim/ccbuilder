...
| **workspace 예약** | `workspace`는 예약된 서버 이름 — 해당 이름 서버 경고 후 스킵 (v2.1.128); `/clear` 후 VS Code·JetBrains·SDK MCP 서버 소멸 버그 수정; OAuth 동시 리프레시 토큰 손실 수정 (v2.1.136) |
...
---
**Status**: 2026-05-03 | **Claude Code**: v2.1.138+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
