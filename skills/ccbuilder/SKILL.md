...
| 기능 | 설명 |
|------|------|
| **HTTP Transport** | 권장 transport (`--transport http`), SSE deprecated; `http`로 설정했지만 레거시 HTTP+SSE만 지원하는 서버는 자동으로 SSE 폴백 (MCP 스펙 준수, v2.1.265) |
...
---
**Status**: 2026-06-18 | **Claude Code**: v2.1.266+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
