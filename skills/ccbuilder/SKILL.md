...
### Task Management (v2.1.233부터 Opus 4.8·Sonnet 5·Fable 5·Mythos 5+ 기본 비활성화 — `CLAUDE_CODE_ENABLE_TODO_TOOLS=1`로 복원)
...
---
**Status**: 2026-06-18 | **Claude Code**: v2.1.235+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
