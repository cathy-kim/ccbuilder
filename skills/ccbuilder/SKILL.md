...
| **MCP stdio/Reconnect** | stdio 서버에 `CLAUDE_PROJECT_DIR` env 자동 주입 (hooks와 동일); Remote MCP 재연결 재시도 전체 활성화; `/mcp` Reconnect로 `.mcp.json` 편집 반영 (v2.1.139) |
...
---
**Status**: 2026-05-03 | **Claude Code**: v2.1.139+ | **Sync**: [version-sync.md](references/version-sync.md) | [check-updates.sh](../../scripts/check-updates.sh)
